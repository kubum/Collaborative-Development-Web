...
set :scm, :git
set :repository,  "git@github.com:kubum/Collaborative-Development-Web.git"

set :user, "hosting_insight"
set :use_sudo, false
set :deploy_to, "/home/hosting_insight/projects/university"
...
set :unicorn_pid, "/var/run/unicorn/university.insight.pid"
